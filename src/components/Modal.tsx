          ...
          >
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.2 }}
                className={`${sizeClasses[size]} w-full bg-card rounded-lg shadow-xl overflow-hidden border border-theme ${isDark ? 'shadow-dark-md' : ''}`}
              ...
              >
                ...
                <div className="flex justify-between items-center p-6 border-b border-theme">
                  ...
                  <button
                    onClick={onClose}
                    className="text-secondary-color hover:text-primary-color focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full p-1"
                    aria-label="Close"
                  >
                    <X className="w-5 h-5" />
                  </button>
